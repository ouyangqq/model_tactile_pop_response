...
for ch in range(2):  #3 afferent types
    ...
    for k in range(len(PFs)): 
        ...
        for j in range(len(rads)): 
            ...
            Aeeps=imeqst.constructing_equivalent_probe_stimuli_from_pimage(pimage[0]+baseh,pimage[1],pimage[2],mysim.fingertiproi)
...
def plot_impulses_response_as_func_of_curvature_for_SA1():
    ...
    plt.ylabel('Firing rate (spikes/s)',fontsize=8)   
