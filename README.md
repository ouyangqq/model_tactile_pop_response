...
(1) simset.py ---> the setup of simulations including: the defination of sampled skin area, Covering certain area in the skin contact (SC) image for each tactile unit ... 
